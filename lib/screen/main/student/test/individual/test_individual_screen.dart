...
class _TestIndividualState extends State<TestIndividual>
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      _answer = List.generate(ts.individualTestGet[0]['answer'].length, (index) => '');
      _controller = List.generate(ts.individualTestGet[0]['answer'].length, (i) => TextEditingController());

      if (args.isChecked == 'true') {
        _score();
      } else {
        ts.individualAnswer.value = List.generate(ts.individualTestGet[0]['answer'].length, (index) => '');
      }
                              ...
                              Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        children: [
                                          ts.individualTestGet[0]['audio'][index].contains('no')
                                              ? SizedBox(
                                                  height: 40,
                                                  child: Container())
