...
//   int _indexTime3 = 0;
//   int _indexTime4 = 0;
//   var hourList = new List<int>.generate(25, (i) => i);
...
//           _titleCon.text = '구인구직 작성';
//           _bodyCon.text = '구인구직 작성';
//           _ageCon.text = '';
//           _moneyCon.text;
//           ///사진추가
//           // if (widget.imgLength != '0') {
//           //   for (int i = 0; i < int.parse(widget.imgLength); i++) {
//           //     _firebaseImg.add(
//           //         'https://firebasestorage.googleapis.com/v0/b/clicksound-af0c0.appspot.com/o/picture%2F${rp.phoneNumber}%2F${pp.setDocId}%2F${_myHospitalList[0]['images'][i]}?alt=media');
//           //   }
//           // }
//           _dropdown = '';
//           _dropdown2 = '월급';
...
//                                               scrollController: FixedExtentScrollController(initialItem: _indexTime),
//                                               itemExtent: 60,
//                                               diameterRatio: 0.9,
//                                               looping: true,
//                                               onSelectedItemChanged: (index) {
//                                                 setState(() {
//                                                   this._indexTime = hourList[index];
//                                                 });
//                                               },
...
//                                                     (index, value) {
//                                                   return Center(
//                                                     child: Text(value.toString().padLeft(2,'0'), style: f16w400,),
//                                                   );
//                                                 },
//                                               ),
//                                             ),
...
//                                             width: 40,
//                                             child: CupertinoPicker(
//                                               scrollController: FixedExtentScrollController(initialItem: _indexTime2),
//                                               itemExtent: 60,
//                                               diameterRatio: 0.9,
//                                               looping: true,
//                                               onSelectedItemChanged: (index) {
//                                                 setState(() {
//                                                   this._indexTime2 = minList[index];
//                                                 });
//                                               },
//                                               selectionOverlay: Container(),
//                                               // selectionOverlay: CupertinoPickerDefaultSelectionOverlay(
...
//                                             width: 40,
//                                             child: CupertinoPicker(
//                                               scrollController: FixedExtentScrollController(initialItem: _indexTime3),
//                                               itemExtent: 60,
//                                               diameterRatio: 0.9,
//                                               looping: true,
//                                               onSelectedItemChanged: (index) {
//                                                 setState(() {
//                                                   this._indexTime3 = hourList[index];
//                                                 });
//                                               },
//                                               selectionOverlay: Container(),
//                                               // selectionOverlay: CupertinoPickerDefaultSelectionOverlay(
...
//                                             width: 40,
//                                             child: CupertinoPicker(
//                                               scrollController: FixedExtentScrollController(initialItem: _indexTime4),
//                                               itemExtent: 60,
//                                               diameterRatio: 0.9,
//                                               looping: true,
//                                               onSelectedItemChanged: (index) {
//                                                 setState(() {
//                                                   this._indexTime4 = minList[index];
//                                                 });
//                                               },
//                                               selectionOverlay: Container(),
//                                               // selectionOverlay: CupertinoPickerDefaultSelectionOverlay(
